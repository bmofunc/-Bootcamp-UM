...
// toggle seperti saklar.. kalo ada dia remove, kalo ga ada dia nambahin
box1.classList.toggle('aquabotol'); // nambahin
box1.classList.toggle('aquabotol'); // remove
box1.classList.add('nyala'); 
...
/*
// InsertAdjancentHTML (manipulasi untuk penyisipan element html)
<!-- beforebegin -->
<p>
  <!-- afterbegin -->
  foo
...
p.insertAdjacentHTML('afterend', info("Helo duniaaaaaaaaaa"))



// Add event listener (ngasih perlakuan/behaviour/otak/instruksi/proses)
// click = button di klik / element yg di click 
// input = ketika input value 
// keyup = ketika keyboard selesai di klik (pressing button keatas)
...
form.addEventListener('submit', function(e) {
    e.preventDefault(); // cegah sifat aslinya 
    // console.log(form.querySelector('input').value); 
    console.log(document.querySelector('input[type="username"]').value); 
})
